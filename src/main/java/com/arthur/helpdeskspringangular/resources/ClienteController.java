...
import com.arthur.helpdeskspringangular.services.ClienteService;
...
public class ClienteController {
    ...
    public ResponseEntity<ClienteDTO> create(@Valid @RequestBody ClienteDTO clienteDTO){
        Cliente newcliente = clienteService.add(clienteDTO);
        URI uri = ServletUriComponentsBuilder.fromCurrentRequestUri().path("/{id}").buildAndExpand(newcliente.getId()).toUri();
